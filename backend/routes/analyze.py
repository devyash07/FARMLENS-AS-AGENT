...
async def analyze(
    ...
    # Run AI prediction with language parameter through the Multi-Agent Orchestrator
    print(f"[Analyze] Orchestrating agents for analysis with language: {language}")
    result = orchestrator.run_diagnostics(file_bytes, language=language)
